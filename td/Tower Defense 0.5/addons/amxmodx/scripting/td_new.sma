...
public RemoveTower() {
	/* Usuwa g3ówn1 wie?e z serwera je?li istnieje */
...
#if defined DEBUG
							log_to_file(gszLogFile, "DEBUG: [To nie musi byæ b³¹d] Przedmiot ^"%s^" w pliku konfiguracyjnym sklepu zawiera opis skladajacy sie z kilku linijek.", szFile)
#endif	
							iMulti = true;
							remove_quotes(szText);
...
#if defined DEBUG
							log_to_file(gszLogFile, "DEBUG: [To nie musi byæ blad] Klasa ^"%s^" w pliku konfiguracyjnym klas gracza zawiera nazwe skladajaca sie z kilku linijek.", szFile)
#endif	
							iMulti = true;
							remove_quotes(szText);
							formatex(szTemp, 63, "%s", szText)
...
#if defined DEBUG
							log_to_file(gszLogFile, "DEBUG: [To nie musi byæ blad] Klasa ^"%s^" w pliku konfiguracyjnym klas gracza zawiera opis skladajacy sie z kilku linijek.", szFile)
#endif	
							iMulti = true;
							remove_quotes(szText);
							formatex(szTemp, 127, "%s", szText)
