...
public CreateTurretRanger(iPlayer, iEnt, iRangerLevel)
{
	...
	entity_set_float(iRanger, EV_FL_scale, g_TurretsRangeData[ entity_get_int(iEnt, EV_INT_turret_type) ][iRangerLevel] / 250.0)
...
public TurretThink(iTurretEntity) 
{
	...
	if(iCanShoot && is_valid_ent(iTarget)) 
	{
		...
		/* If entities are visible, check distance between them */
	...
	iTarget = TurretGetClosestMonster(iTurretEntity, TurretOrigin, float(g_TurretsRangeData[iTurretType][g_PlayerTurretRangeLevel[iPlayer][iTurretIndex]]))
...
{	
	...
	g_TurretsDamageData[iTurretType][iDamageLevel][0], g_TurretsDamageData[iTurretType][iDamageLevel][1],
	g_TurretsRangeData[iTurretType][g_PlayerTurretRangeLevel[id][iTurretIndex]], g_TurretsAccuracyData[iTurretType][ g_PlayerTurretAccuracyLevel[id][iTurretIndex] ], fFireRate)
